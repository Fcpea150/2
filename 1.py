...
RfuBot=[lineMID]
Family=["u0e90d8042d7b22064e26853868713db8",lineMID]
admin=['u0e90d8042d7b22064e26853868713db8',lineMID]
adminMID="u0e90d8042d7b22064e26853868713db8"
...
settings = {
    ...
    "kick":"😱อุ๊ต๊ะ..😱",
    "bye":"🙌บ๊าย..บาย😭",
    "Respontag":"""   [สายรัน 🔰 ไร้สังกัด]\n
    แทคทมายย..คิดถึงเค้าอ่ะดิ😘\n
รับติดเชล Python3
ความเร็ว 0.2 sc.
-เข้ากลุ่มอัตโนมัติได้
-แทคได้
-บล็อคออโต้ได้
-กันรัน ลบรันได้
-เชิญโทรได้
-ตั้งข้อความ ต้อนรับ เข้า-ออกได้
-สั่งบินได้ (แต่คุณจะบัคทันที)
-สั่งเตะ ลบคนที่ละคนได้
(ราคา) ราคาเพียง 0 บาท  ทำฟรีจริงไรจริง สอนจริง ไรจิง /เดือน
ลูกเล่นตามราคา มีหลายเกรด  สนใจเชลบอท พรีเมี่ยม เปลี่ยนได้แต่ เสียเงินใหม่น่ะจ่ะ

สนใจสอบถามได้ 
▶⚠ลงบอทป้องกัน กลุ่มไลน์
▶⚠ลงบอทเสริมเพิ่ม ทักแชท
▶⚠ซื้อตั๋ว บอทสิริ ทักแชท
▶⚠รับทำบอทกันรัน แท็ก อื่นๆ
▶⚠ปรึกษาเรื่องบอท ในไลน์
▶⚠ปรึกษาเรื่องส่วนตัว ตามลิ้งครับ

http://line.me/ti/p/~fcpea001 
แอดมาแล้วทักรัวๆ
PEA ทีมงานไร้สังกัด
♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻♻
""",
    ...
    "responcall": False,
    "responcallgc": False,
    "restartPoint": "u0e90d8042d7b22064e26853868713db8",
    "server": "VPS",
    "ksticker": False,
    "timeRestart": "18000",
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย 🇹🇭 แมวเป้ 🔰 ไร้สังกัด",
    "comment":"""™─┅❈͜͡🇹🇭แมวเป้ 🔰 ไร้สังกัด🇹🇭✯͜͡❈┅─""",
    "userAgent": [
...
╠═══════════════┛
╠❂➣ 🔰คำสั่ง [คำสั่งเซลบอท]
╠❂➣ 🔰คำสั่ง1 [คำสั่งในกลุ่ม]
╠❂➣ 🔰คำสั่ง2 [คำสั่งตั้งค่า]
╠❂➣ 🔰คำสั่ง3 [คำสั่งโซเชล]
╠❂➣ 🔰คำสั่ง4 [คำสั่งเปิด/ปิด]
╠❂➣ 🔰คำสั่ง5 [คำสั่งแปลภาษา]
╠❂➣ 🔰คำสั่ง6 [คำสั่งคิกเกอร์]
...
「วิธีใช้ : say-th ผมชื่อเป้นะครับ」"""
...
#==============================================================================#
                ...
                if text.lower() == 'คำสั่ง':
                    ...
                    line.sendMentionFooter(to, '「ผู้สร้างบอท」\n', sender, "https://line.me/ti/p/~fcpea001", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~fcpea001', 'type': 'mt', 'subText': "WEE SELFBOT", 'a-installUrl': 'https://line.me/ti/p/~fcpea001', 'a-installUrl': ' https://line.me/ti/p/~fcpea001', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~fcpea001', 'i-linkUri': 'https://line.me/ti/p/~fcpea001', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~fcpea001'}, contentType=19)
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u0e90d8042d7b22064e26853868713db8"
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u0e90d8042d7b22064e26853868713db8")
...
#==============================================================================#
                ...
                elif "เว้า " in msg.text:
                    txt = msg.text.split(" ")
                    jmlh = int(txt[2])
                    teks = msg.text.replace("เว้า "+str(txt[1])+" "+str(jmlh)+" ","")
                    tulisan = jmlh * (teks+"\n")
                    if txt[1] == "เปิด":
                        if jmlh <= 100000:
                           for x in range(jmlh):
 ...
 #                   kc.sendMessage(to, "Ping")      
  #                  ke.sendMessage(to, "Ping")         
                    ...
                    for x in range(jml):
                        ...
                        line.sendMessage(to, "ทำการโทรเสดแล้วนายจ๋า".format(str(jml)))
...
#                               aditmadzs.sendMessage(msg.to,"KI\n"+ki.authToken)
                    ...
                    for i in gid:
                        line.sendImageWithURL(i, bc)
                elif ".เสียงกลุ่ม " in msg.text:
                    bctxt = msg.text.replace(".เสียงกลุ่ม ", "")
                    bc = ("สายรัน ไร้สังกัด เชล บอท")
                    cb = (bctxt + bc)
                    ...
                    if msg.text.lower().lstrip().rstrip() in wbanlist:
                        if msg.text not in lineMID:
                            try:
                                ...
                                line.sendMessage("คุณพูดคำต้องห้าม จำเป็นต้องนำออก เสียใจด้วยน่ะ PEA แมสเป้")
                            except Exception as e:
                                print(e)
